...
def process_audio_file(file_path: str, target_format: str = 'wav', target_sample_rate: int = 44100,
                       target_bit_depth: int = 16, target_channels: int = 2):
    ...
    output_format = 'AIFF' if output_file_extension in ['aif', 'aiff'] else output_file_extension
    ...
    y, sr = librosa.load(file_path, sr=None, mono=False)  # Load with original sample rate and preserve channels
